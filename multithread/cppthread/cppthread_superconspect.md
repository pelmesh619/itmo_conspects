...
* [Программирование на C++ с элементами многопоточности](#%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0-c%2B%2B-%D1%81-%D1%8D%D0%BB%D0%B5%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D0%BC%D0%B8-%D0%BC%D0%BD%D0%BE%D0%B3%D0%BE%D0%BF%D0%BE%D1%82%D0%BE%D1%87%D0%BD%D0%BE%D1%81%D1%82%D0%B8)
  ...
  * [Лекция 7. Продвинутые инструменты Qt](#%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-7.-%D0%BF%D1%80%D0%BE%D0%B4%D0%B2%D0%B8%D0%BD%D1%83%D1%82%D1%8B%D0%B5-%D0%B8%D0%BD%D1%81%D1%82%D1%80%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B-qt)
    * [Разделение памяти между потоками](#%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%BF%D0%B0%D0%BC%D1%8F%D1%82%D0%B8-%D0%BC%D0%B5%D0%B6%D0%B4%D1%83-%D0%BF%D0%BE%D1%82%D0%BE%D0%BA%D0%B0%D0%BC%D0%B8)
  * [Лекция 8. Упорядочивания в `std::atomic` и барьеры памяти](#%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-8.-%D1%83%D0%BF%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D1%87%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B2-%60std%3A%3Aatomic%60-%D0%B8-%D0%B1%D0%B0%D1%80%D1%8C%D0%B5%D1%80%D1%8B-%D0%BF%D0%B0%D0%BC%D1%8F%D1%82%D0%B8)
...
<!-- begin cppthread_2026_03_18.md -->
## <a name="%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-7.-%D0%BF%D1%80%D0%BE%D0%B4%D0%B2%D0%B8%D0%BD%D1%83%D1%82%D1%8B%D0%B5-%D0%B8%D0%BD%D1%81%D1%82%D1%80%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D1%8B-qt"></a> Лекция 7. Продвинутые инструменты Qt
...
### <a name="%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%BF%D0%B0%D0%BC%D1%8F%D1%82%D0%B8-%D0%BC%D0%B5%D0%B6%D0%B4%D1%83-%D0%BF%D0%BE%D1%82%D0%BE%D0%BA%D0%B0%D0%BC%D0%B8"></a> Разделение памяти между потоками

Истинное разделение (True sharing) возникает, когда несколько потоков одновременно читают и пишут одну и ту же область памяти - общую переменную или элемент массива. Без синхронизации это приводит к гонке данных и неопределённому поведению. Классический пример - два потока инкрементируют общий счётчик `int counter`. Каждый делает тысячу итераций `counter++`, но из-за неатомарности операции итоговое значение часто оказывается меньше 2000

Защитить доступ можно классическим мьютексом `std::mutex` в паре с `std::lock_guard`, который гарантирует взаимное исключение. Однако более лёгкая и производительная альтернатива для простых типов - `std::atomic<T>`. Атомарные операции выполняются за одну неделимую инструкцию процессора, без блокировок и переключений контекста. Например, `std::atomic<int>::fetch_add(1)` или просто `++counter`, если `counter` - атомарная переменная. При этом итоговый счётчик всегда будет в точности равен ожидаемому

```cpp
std::atomic<int> counter{0};

void increment() {
    counter.fetch_add(1); // атомарно, безопасно из любого числа потоков
}
```
...
```
<!-- end cppthread_2026_03_18.md -->

<!-- begin cppthread_2026_03_25.md -->
## <a name="%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-8.-%D1%83%D0%BF%D0%BE%D1%80%D1%8F%D0%B4%D0%BE%D1%87%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B2-%60std%3A%3Aatomic%60-%D0%B8-%D0%B1%D0%B0%D1%80%D1%8C%D0%B5%D1%80%D1%8B-%D0%BF%D0%B0%D0%BC%D1%8F%D1%82%D0%B8"></a> Лекция 8. Упорядочивания в `std::atomic` и барьеры памяти
