...
* Корутин
    ...
    В стандарте C++20 корутины бесстековые, и тот вид, в которой они представлены, спорен, поэтому их использовать рекомендуется под в связке с оборачивающей их библиотекой
