...
Важно заметить, что для создания пространства PID нужно использовать флаг `--fork`, иначе новое пространство PID будут иметь дочерние процессы, который были порождены указанного команды, а не сам процесс команды
