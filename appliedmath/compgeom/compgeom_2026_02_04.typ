...
#show "Геометрия": text(purple)[Геометрия]
...
+ Поворот 
  ...
  Активное преобразованием называется поворот плоскости, а пассивным -- поворот системы координат. Такие преобразование взаимно обратны
