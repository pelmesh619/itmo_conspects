...
+ Алгоритм Брезенхэма
    ...
    - Если $d_i >= 0$, выбираем пиксель $T_i$ с координатами $(x_i, y_i)$. Тогда приращение координаты $y$ равно 1, и формула упрощается:
    $d_(i+1) = d_i + 2(d y - d x)$
    - Если $d_i < 0$, выбираем пиксель $S_i$ с координатами $(x_i, y_(i-1))$. Здесь $y_i = y_(i-1)$, поэтому
    $d_(i+1) = d_i + 2d y$
