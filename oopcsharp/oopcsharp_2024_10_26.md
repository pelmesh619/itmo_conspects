...
Сделаем класс `ExpressionRenderable` - он будет _мостом_ между интерфейсов `IRenderable` и `IExpression`. При вызове `Render` объект будет возвращать текстовое представление выражения.
