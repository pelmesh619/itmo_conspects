...
\begin{document}
    ...
    \vspace{3mm}
\textit{Nota}. Будем искать поправочный коэффициент так, чтобы $\Delta s_i \approx \text{коэфф.} \cdot \Delta s_i^\prime$
    ...
    \textbf{
    \vspace{3mm}
\textit{Nota}. В пределе это точное равенство:}
    ...
    \vspace{3mm}
\textit{Def}. Определитель $\displaystyle J = \begin{vmatrix}
    ...
    \vspace{3mm}
\textit{Ex}. $T: \begin{matrix}x^2 + y^2 = z^2 \\ x^2 + y^2 = z\end{matrix}$
