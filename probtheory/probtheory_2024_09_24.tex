...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item $np + p$ -- целое, тогда $np + p - 1$ -- целое, и 2 наиболее вероятных числа успеха
    \end{enumerate}
    ...
    \begin{enumerate}
        \item Локальная формула Муавра-Лапласа
        ...
        \begin{itemize}
            \item $\varphi(x) = \varphi(-x)$ -- функция четная

            \item при $x > 5 \quad \varphi(x) \approx 0$
        \end{itemize}

        \hypertarget{integralformulademoivrelaplace}{}

        \item Интегральная формула Муавра-Лапласа (если требуется найти вероятность того, что число успехов в данном диапазоне)
        ...
        \begin{itemize}
            \item $\Phi(-x) = -\Phi(x)$ -- функция нечетная

            \item при $x > 5 \quad \Phi(x) \approx 0.5$
        \end{itemize}
    \end{enumerate}
    ...
    \begin{enumerate}
        \item $x = \frac{k - np}{\sqrt{npq}} = \frac{330 - 400 \cdot 0.8}{\sqrt{400 \cdot 0.8 \cdot 0.2}} = \frac{330 - 320}{8} = 1.25$

        $p_{400}(330) \approx \frac{1}{\sqrt{npq}} \varphi(1.25) = \frac{1}{8} \varphi(1.25) \approx \frac{1}{8} \cdot 0.1826 \approx 0.0228$

        \item $x_1 = \frac{312 - 320}{8} = -1$, $x_2 = \frac{336 - 320}{8} = 2$
