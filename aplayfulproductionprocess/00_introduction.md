...
|--------------------------------------------------------------|-------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|------------------|
| \ Исследования <br/> \ Идеи и прототипы <br/> \ Цели проекта | \ Вертикальный срез <br/> \ Макродизайн <br/> \ График выполнения работ | \ Альфа-версия <br/> \ Майлстоун альфа-версии <br/> \ Бета-версия <br/> \ Майлстоун бета-версии | \ Релиз-кандидат |](images/00_introduction_01.png)
