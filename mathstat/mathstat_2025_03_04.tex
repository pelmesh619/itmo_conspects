...
\begin{MyProof}
    ...
    \begin{enumerate}
        ...
        \item $\sum_{i = 1}^n \frac{(X_i - \overline{x})^2}{\sigma^2} = \sum_{i = 1}^n \left(\frac{X_i - a}{\sigma} - \frac{\overline{x} - a}{\sigma}\right)^2 = 
        \sum_{i = 1}^n (Y_i - \overline{Y})^2$, где $Y_i = \frac{X_i - a}{\sigma} \in N(0, 1)$, $\overline{Y} = \frac{1}{n} \sum_{i = 1}^n Y_i = \frac{\sum_{i = 1}^n X_i - na}{\sigma} = \frac{\overline{x} - a}{\sigma}$

        $\vec Y = (Y_1, \dots , Y_n)$ -- стандартные нормальные вектора.
