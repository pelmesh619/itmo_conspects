...
\subsection{Модифицированная лемма Фишера (y28 notes)}
...
\begin{MyTheorem}
    ...
    соответсвующий точке в пространсве $\Real^n$. $L \subset Real^n$ - минимальное подпространство размерности $k$, 
...
\begin{MyProof}
    ...
    $f_{k+1}, f_{k+2}, \dots , f_n$ - его ортонормированние дополнение до базиса $\Real^n$.
...
\begin{MyProof}
    Альтернативное доказательство через модифицированную лемму Фишера (y28 notes)
    \begin{enumerate}
