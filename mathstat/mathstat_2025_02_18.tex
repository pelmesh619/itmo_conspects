...
\end{center}
Так как $\vec{BX} \cdot \vec S = (x_1 - \bar x, x_2 - \bar x, \dots , x_n - \bar x) \cdot (1, 1, \dots , 1) = \sum_{i = 1}^{n}(x_i - \bar x) = \sum_{i = 1}^{n}x_i - \sum_{i = 1}^{n} \bar x = n \bar x - n \bar x = 0 \Rightarrow$
