...
* Прикладная математика
    ...
    * Вычислительная геометрия (лектор Далевская О. П.)
        ...
        * [Лекция №9](https://pelmesh619.github.io/itmo_conspects/conspects/appliedmath/compgeom/compgeom_2026_04_01.pdf)
...
* Администрирование в ОС Linux (лектор Дяченко Е. О.)
    ...
    * Extra 4. Графические среды - TODO
...
* Исправить ошибки компиляции конспектов `mathstat`, `probtheory`, `physics1`, `physics2`, `physics3`
