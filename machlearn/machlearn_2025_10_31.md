...
$$P(\text{письмо -- спам} \vert \text{в письме есть слова «выиграли» и др.}) = \frac{P(\text{в письме есть слова «выиграли» и др.} \vert \text{письмо -- спам}) P(\text{письмо -- спам})}{P(\text{в письме есть слова «выиграли» и др.})}$$
