...
Несложно показать, что ширина зазора равна $\frac{2}{\| w \|}$ ($\frac{2}{\| w \|} = \frac{|w^T x + b + 1| - |w^T x + b - 1|}{\|w\|}$ - расстояние между точками, удаленных на один от точки $x$ на гиперплоскости)
