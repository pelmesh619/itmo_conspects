...
\begin{document}
    ...
    4* \enquote{Суммирование} элементарных величин $\int gd\omega$ или $\int \overrightarrow{G}d\overrightarrow{\omega}$
    ...
    $n = 1$: * прямая (определенный интеграл $\int_a^b$)

    * кривая (криволинейный интеграл $\int_A^B$)

    $n = 2$: * плоскость (двойной интеграл $\iint_D$)

    * поверхность, не криволинейная (поверхностный интеграл $\iint_S$)
