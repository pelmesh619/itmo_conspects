...
\Nota Это аналогия с односторонними пределами $\Real$-функций
...
То есть линейная функция - комбинация линейных перемещений
...
Заметим, что $\mathrm{arg} z_1 = \mathrm{arg} z_2 \pm \pi$ 
...
\ExN{4} Показательная $w = e^z = e^x + e^{iy} = e^x (\cos y + i \sin y)$
